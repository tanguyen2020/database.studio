<script lang="ts">
  ...
  import { CATEGORY_ORDER, ENV_COLORS, ENV_LABELS, SYSTEM_ORDER, systemMeta } from '$lib/systems'
          ...
          <ContextMenu.Root>
            <ContextMenu.Trigger>
              ...
              >
                ...
                <span
                  class="rounded-sm px-1 py-px text-[8.5px] font-bold leading-none"
                  style="color: {ENV_COLORS[p.env]}; border: 1px solid {ENV_COLORS[p.env]}66;"
                >
                  {ENV_LABELS[p.env]}
                </span>
                <div class="grow"></div>
