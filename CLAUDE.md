...
- **T20 — ER create-relationship + Save-to-DB — ⏳ NEXT** ("+Relationship" vẽ FK + "Save to DB" phát `ALTER TABLE … ADD CONSTRAINT FK`; cardinality 1/N; in-tab Ctrl+F. unit ALTER-ADD-FK gen; integration apply lên seeded PG pair → introspect FK tồn tại).
- T21..T23 — pending (see SPEC_SUPPLEMENT.md "Implementation priority").
