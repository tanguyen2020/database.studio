...
- **T18 — Explorer depth — ⏳ NEXT** (View column expansion; Proc/Func/Trigger context menu Show Definition/Drop; index/constraint detail children; tree Ctrl+F search; right-side Object Properties panel. visual + unit DDL/definition gen; integration Show Definition trả server text thật).
- T19..T23 — pending (see SPEC_SUPPLEMENT.md "Implementation priority").
