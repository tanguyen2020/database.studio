...
- **T19 — Schema Compare depth — ⏳ NEXT** (include procedures/functions/triggers; side-by-side DDL diff panel prev/next + highlight. unit diff over routine DDL; integration 2 seeded PG schemas khác nhau 1 proc + 1 column → statuses + migration).
- T20..T23 — pending (see SPEC_SUPPLEMENT.md "Implementation priority").
